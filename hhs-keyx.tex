...
(maybe up to a twist of $E'$) %% todo BS: I don't think there's a twist here
...
Generalizing Regev's ideas to more efficient
versions of Kuperberg's algorithm remains an open problem.
