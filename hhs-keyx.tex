...
this means that a secret key assigns 
\begin{itemize}
    \item
        an exponent in 
    ...
    \item
        ...
        primes).
\end{itemize}
But assuming these parameters have been properly chosen,
Algorithm~\ref{alg:isogeny-KeyGen} (\algstyle{KeyGen})
implements key generation for the resulting cryptographic schemes.
