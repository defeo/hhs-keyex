...
assumptions and give security proofs against passive
adversaries. Finally, we discuss key validation and protection against
active adversaries.
...
time complexity of this attack is $\softO(\sqrt{h})$. As a consequence,
the CM method~\cite{todo:CMmethod}, that constructs elliptic curves
with prescribed cardinalities using \emph{small} class numbers,
must be discarded in our setting.
