...
Therefore, we believe taking $O = 4$ in Kuperberg's estimate
is a reasonable choice to propose precise parameter sizes.
(We mention that Kuperberg's original analysis gave $O = 3$).
