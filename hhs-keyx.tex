...
but only $O(\log N)$ quantum space. Unfortunately, his analyses
are only asymptotic and in simplified cases, so cannot be directly used
for concrete parameter design.
