...
\begin{figure}[t]
  ...
  \begin{minipage}{0.45\textwidth}
    ...
    \caption{Schreier graph on a group $〈x〉$ of order $13$, acted
      ...
      $13$, thus partitioning $G\setminus\{1\}$ into $3$ cycles of
      length $4$.}
    \label{fig:cayley}
  \end{minipage}
\end{figure}
...
\begin{algorithm}
  ...
  \Params{A \emph{base point} $x_0∈X$}
  \Alice{
    \Samples a \emph{random walk} $(a_i)_i$ in $\Graph(G,S,X)$\;
...
will be simply evaluated as the composition of each isogeny step
$ϕ_{\frak s_i}$.
